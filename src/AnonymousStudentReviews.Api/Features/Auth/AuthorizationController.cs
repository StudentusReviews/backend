...
public class AuthorizationController : Controller
{
    ...
    public AuthorizationController(
        ...
        IOpenIddictScopeManager scopeManager, IUserManager userManager, ISignInManager signInManager)
    {
    ...
    public async Task<IActionResult> Authorize()
    {
        ...
        var getUserResult = await _userManager.GetUserAsync(result.Principal);
    ...
    public async Task<IActionResult> Accept()
    {
        ...
        // Retrieve the profile of the logged-in user.
        var getUserResult = await _userManager.GetUserAsync(User);
    ...
    public async Task<IActionResult> Exchange()
    {
        ...
        if (request.IsAuthorizationCodeGrantType() || request.IsRefreshTokenGrantType())
        {
            ...
            var getUserResult = await _userManager.FindByIdAsync(result.Principal!.GetClaim(Claims.Subject)!);
            if (getUserResult.IsFailure)
            {
                return Forbid(
                    authenticationSchemes: OpenIddictServerAspNetCoreDefaults.AuthenticationScheme,
